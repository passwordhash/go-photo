...
import (
	...
	serviceModel "go-photo/internal/service/auth/model"
...
func (h *handler) register(c *gin.Context) {
	...
	userUUID, err := h.authService.Register(c, serviceModel.RegisterParams{
		Email:    input.Email,
	...
	response.NewOk(c, auth.Register{userUUID})
}
